...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          {\textbf{LLMs - PoS Tagging with Layer Freezing} $|$ \emph{Python, DistilBERT Transformers}}{February 2024}
          \resumeItemListStart
          ...
          \vspace{-13pt}
          \resumeProjectHeading
          {\textbf{LLMs - Character-Level Language Modeling using GPT} $|$ \emph{Python, PyTorch, Transformers}}{December 2023}
          \resumeItemListStart
